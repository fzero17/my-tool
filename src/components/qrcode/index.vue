...
<template>
  <div class="flex w-full h-full">
    ...
    <div class="flex flex-col w-1/2 pt-5">
      ...
      <textarea id="text" class="border border-b-gray-300 h-40" v-model="qrCodeString"/>
      <label for="title" class="font-light">备注一</label>
      <input id="title" class="border border-b-gray-300" v-model="title" @input="onTextChange"/>
      <label for="subTitle" class="font-light">备注二</label>
